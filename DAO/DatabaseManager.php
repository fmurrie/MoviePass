...
abstract class DatabaseManager {
    ...
    private static function createDatabase() {
        ...
        try
        {
            ...
            $query = "create table movie_theaters
            ...
            $query = "create table genres_per_movie
            (id_movie int,
            id_genre int,
            ...
            $query = "alter table payments add constraint fk_payments_purchases foreign key(id_purchase) references purchases(id_purchase);";
            $value = $connection->executeNonQuery($query);
            ...
            $query = "create table users_online(id_user int,ip_address varchar(100),country varchar(100),
            ...
            $query = "insert into user_roles (description) values ('user'),('admin');";
            $value = $connection->executeNonQuery($query);

            $query = "insert into users (email, password, id_user_role) values ('admin@admin', '$2y$12" . "$" . "q.zS7nRxhM.PJvoc/HjptOEqy6o5ba.H34thBnw7spPjCPOeP9y7u', 2);";
            $value = $connection->executeNonQuery($query);
        }
